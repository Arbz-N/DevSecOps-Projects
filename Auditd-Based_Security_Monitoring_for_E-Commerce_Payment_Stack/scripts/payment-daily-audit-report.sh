...

{
  ...
  echo "Config Changes (24h): $(sudo ausearch -k nginx_main_config -i --start today 2>/dev/null | wc -l)"
  echo "Process Events (24h): $(sudo ausearch -k nginx_process -i --start today 2>/dev/null | wc -l)"
  echo "Load balancer config changes (24h): $(sudo ausearch -k nginx_lb_config -i --start today 2>/dev/null | wc -l )"
  echo "Load balancer enabled changes (24h): $(sudo ausearch -k nginx_lb_enabled -i --start today 2>/dev/null | wc -l )"
  echo "Access logs changes (h): $(sudo ausearch -k nginx_access_logs -i --start today 2>/dev/null | wc -l )"
  echo "Error logs changes (24h): $(sudo ausearch -k nginx_error_logs -i --start today 2>/dev/null | wc -l )"
  echo ""
  ...
  echo "Error logs changes (24h): $(sudo ausearch -k apache_8080_error_logs -i --start today 2>/dev/null | wc -l )"
  echo ""
  echo "BACKEND 2 (8081)"
  ...
  echo "Error logs changes (24h): $(sudo ausearch -k apache_8081_error_logs -i --start today 2>/dev/null | wc -l )"
  echo ""
